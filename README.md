...
| Tag | When |
|-----|------|
| `v0.3.4-snapshot` | Floating latest from `main` for the current release line (after Trivy) |
| `v0.3.4-snapshot.N` | Immutable numbered snapshot for a specific `main` build (after Trivy) |
